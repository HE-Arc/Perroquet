# Generated by Django 3.1.7 on 2021-03-15 14:35
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('PerroquetApp', '0006_auto_20210306_2013'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='like',
            name='message',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='like', to='PerroquetApp.message'),
        ),
        migrations.AlterField(
            model_name='message',
            name='author',
